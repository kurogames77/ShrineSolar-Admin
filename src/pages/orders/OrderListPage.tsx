...
export function OrderListPage() {
  ...
  const downloadCompletedOrders = () => {
    const completed = orders.filter(o => o.status === 'completed' && (downloadCustomer === 'all' || o.customer_name === downloadCustomer))
    ...
    const html = `
      ...
      <table>
        <tr><th>Order #</th><th>Customer</th><th>Product</th><th>Quantity</th><th>Amount</th><th>Order Date</th></tr>
              ...
              <thead>
                <tr className="border-b border-slate-200">
                  {([
                    ...
                    { key: 'size_or_qty' as SortKey, label: 'Quantity' },
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white shadow-xl border border-slate-200 rounded-2xl p-6 w-full max-w-sm animate-[fadeIn_0.15s_ease]">
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                ...
                >
                  ...
                  {Array.from(new Set(orders.filter(o => o.status === 'completed').map(o => o.customer_name))).sort().map(name => (
            ...
            <div className="flex gap-3 justify-end pt-5 mt-2 border-t border-slate-100">
              ...
              <Button onClick={() => { downloadCompletedOrders(); setShowDownloadModal(false); }}>Download</Button>
            </div>
          </div>
        </div>
      )}
